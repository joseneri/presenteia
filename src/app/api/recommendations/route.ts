...
function buildSystemPrompt() {
  return [
    ...
    "O visualAnchorId deve representar um objeto compravel e fotografavel, nao uma paisagem, lugar, cena romantica ou contexto abstrato. Priorize produtos concretos como kit, livro, caneca, fone, luminaria, garrafa, jogo, caixa, voucher fisico ou acessorio.",
